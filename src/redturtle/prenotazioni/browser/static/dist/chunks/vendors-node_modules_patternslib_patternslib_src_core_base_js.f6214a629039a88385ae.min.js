...
"use strict";
(self["webpackChunkredturtle_prenotazioni"] = self["webpackChunkredturtle_prenotazioni"] || []).push([["vendors-node_modules_patternslib_patternslib_src_core_base_js"],{
...
/* harmony import */ var _registry__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./registry */ "./node_modules/@patternslib/patternslib/src/core/registry.js");
...
/* harmony import */ var _mockup_parser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./mockup-parser */ "./node_modules/@patternslib/patternslib/src/core/mockup-parser.js");
/**
...
const log = _logging__WEBPACK_IMPORTED_MODULE_2__["default"].getLogger("Patternslib Base");
const initBasePattern = function ($el, options, trigger) {
  ...
  if (pattern === undefined && _registry__WEBPACK_IMPORTED_MODULE_1__["default"].patterns[name]) {
    try {
      ...
      options = this.prototype.parser === "mockup" ? _mockup_parser__WEBPACK_IMPORTED_MODULE_3__["default"].getOptions($el, name, options) : options;
      pattern = new _registry__WEBPACK_IMPORTED_MODULE_1__["default"].patterns[name]($el, options, trigger);
    } catch (e) {
...
const Base = async function ($el, options, trigger) {
  ...
  this.$el = $el;
  this.el = $el[0];
  this.options = jquery__WEBPACK_IMPORTED_MODULE_0___default().extend(true, {}, this.defaults || {}, options || {});
...
Base.extend = function (patternProps) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default().extend(true, child.prototype, patternProps);
  ...
  if (!patternProps.name) {
    ...
    _registry__WEBPACK_IMPORTED_MODULE_1__["default"].register(child, patternProps.name);
  }
  return child;
};
...
const registry = {
  ...
  scan(content, patterns, trigger) {
    ...
    matches = matches.filter(el => {
      ...
      return !el.matches(".disable-patterns") && !el?.parentNode?.closest?.(".disable-patterns") && !el?.parentNode?.closest?.("pre") && !el?.parentNode?.closest?.("template") &&
...
//# sourceMappingURL=vendors-node_modules_patternslib_patternslib_src_core_base_js.f6214a629039a88385ae.min.js.map